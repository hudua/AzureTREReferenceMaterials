...
aml_compute = AmlCompute(ws, "gpu-shared")

env = Environment.get(workspace = ws, name = "docker-model-training", version = 3)

# env.docker.base_image = '<acr>.azurecr.io/repo/env-train:v1'
